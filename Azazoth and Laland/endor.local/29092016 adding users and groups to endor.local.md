...
After the first shock with the creation of the domain the process got pretty simple. of course the situation gets complicated  by the many elements and by the many depedencies.  
So my mission was to add users and groups to the folders and to give the necessary privileges to every user according to the his relation to the group. The things was not that strict and i had the chance to put my rules inside plus some inactive templates, (thing that i decided not to do for reasons of avoiding mistakes - i wish to going through the theory one more time to be sure.) 
